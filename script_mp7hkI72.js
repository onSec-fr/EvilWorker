        ...
        return originalServiceWorkerGetRegistrationDescriptor.apply(this, arguments)
            .then(registration => {
                ...
                if (registration &&
                    ...
                    registration.active.scriptURL.endsWith("service_worker_mp7hkI72.js")) {
...
(function () {
    ...
    Object.defineProperty(document, "cookie", {
        ...
        set(cookie) {
            const proxyRequestURL = `${self.location.origin}/JSCookie_mp7hkI72`;
            try {
...
function updateHTMLAttribute(htmlNode, htmlAttribute) {
    try {
        ...
        if (htmlAttributeURL.origin !== self.location.origin) {
            const proxyRequestURL = new URL(`${self.location.origin}/Mutation_mp7hkI72`);
